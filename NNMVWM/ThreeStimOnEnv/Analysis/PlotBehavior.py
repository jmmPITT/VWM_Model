...
x25  = np.load("hits_cueInValid25.npy").squeeze(-1)
x50  = np.load("hits_cueInValid50.npy").squeeze(-1)
x75  = np.load("hits_cueInValid75.npy").squeeze(-1)
x100 = np.load("hits_cueInValid100.npy").squeeze(-1)
